...
st.set_page_config(page_title='SHUBH NEWS', page_icon='./Meta/newspaper.ico')

model=pickle.load(open('fake_model.pkl','rb'))

#st.text(model.predict(X))
...
def run():
    st.title("SHUBH NEWS📰")
    image = Image.open('S:/pycharm/News Web Page/Meta/newspaper.png')
